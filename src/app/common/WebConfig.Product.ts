...
export const WebConfig = {
  ...
  // serviceBase: 'http://localhost/Mars.API',
  // serviceBase: 'http://www.parkdragon.net/Mars.API/', // UAT
  serviceBase: 'http://www.mars999s.com/Mars.API',
  // serviceBase: 'http://localhost/Mars.API', //'http://www.parkdragon.net/Mars.API/', // 'http://www.hkgplottery.com', // 'http://192.82.60.55/GHL.API/';'../GHL.API/';'http://www.hkgplottery.com';
  // serviceBase: 'http://www.mars999.net/Mars.API', // Live
  // tslint:disable-next-line: max-line-length
  ...
  // signalRServer: 'http://www.parkdragon.net:8001/signalr', // UAT
  // signalRServer: 'http://www.mars999s.com:8001/signalr',
  signalRServer: 'http://www.mars999.net:8001/signalr',
...
export const ngAuthSettings = Object.freeze({
  appDownloadUrl: {
    kiss918: 'http://c1.d.918kiss.com/',
    mars999_Android: 'http://cdnsec.7stars.asia/APP/Android/mars999.apk?V=20210316',
    mars999_IOS: null,
    mega888: WebConfig.serviceBase + '/Fileupload/AppDownload/Mega888RC.apk',
    kaya918: WebConfig.serviceBase + '/Fileupload/AppDownload/Kaya918RC.apk',
    kiss2918: WebConfig.serviceBase + '/Fileupload/AppDownload/918Kiss2RC.apk',
    pussy888: WebConfig.serviceBase + '/Fileupload/AppDownload/Pussy888RC.apk',
  ...
  appDownloadMsgUrl: [
    { CompanyID: 3, url: 'http://c1.d.918kiss.com/' }
    , { CompanyID: 4, url: 'https://m.mega383.com/' }
    , { CompanyID: 5, url: 'http://dl.918kiss.agency/' }
    , { CompanyID: 6, url: 'http://d.8868fun.com/' }
    , { CompanyID: 7, url: 'http://dm21.pussy888.com/' }
  ],
  apip: 'Test',
