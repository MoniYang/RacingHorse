...
@Component({
  selector: 'app-AppMessageBox',
  templateUrl: './AppMessageBox.component.html',
  styleUrls: ['./AppMessageBox.component.css']
})
export class AppMessageBoxComponent implements OnInit {
  ...
  @Input() modalMsg = {
    ...
    appDownloadMsgUrl: { CompanyID: 3, url: 'http://c1.d.918kiss.com/' },
    callback: '',
    downloadKey: '',
    CreateInfo: {},
    isConfirm: false
  ...
  CallBack(inputData) {
    ...
    this.modalMsg.isConfirm = inputData;
